...
📍 Developer from **Kolkata, India**
⚡ Specializing in **Python backends**, **REST APIs**, and **full-stack web apps**
🧠 Passionate about **backend engineering**, **system design** & **automation**
🗄️ Experienced with **relational databases**, **ORM design**, and **schema migrations**
🤝 Open to collaboration on **FastAPI**, **React**, **Dockerized** & **Node.js** projects
📬 Reach me at: **[abhikrsingh.dev@gmail.com](mailto:abhikrsingh.dev@gmail.com)**
...
- 🧾 **Markdown → PDF converter** — standalone Python script using `pypandoc` + `xelatex`, supporting LaTeX math rendering
- 🎓 **Student Attendance System** — SQLAlchemy ORM-backed app with semester enrollment, subject tracking & attendance recording
